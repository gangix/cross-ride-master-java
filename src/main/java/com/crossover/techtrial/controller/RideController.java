...
public class RideController {
	...
	public ResponseEntity<Ride> createNewRide(@Valid @RequestBody Ride ride) throws Exception {
	...
	public ResponseEntity<List<TopDriverDTO>> getTopDriver(@RequestParam(value = "max", defaultValue = "5") Long count,
		...
		List<TopDriverDTO> topDrivers = topDriverService.getTopDrivers(startTime, endTime, count);
